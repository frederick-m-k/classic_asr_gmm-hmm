...
####### input parameters
if [ $# != 4 ]; then
	echo "Usage: $0 <model_dir> <data_dir> <test_or_train> <lm>"
	echo "  e.g.: $0 exp/mono/ data test data/lang"
	echo "  e.g.: $0 exp/mono_cleaned phatts_cleaned_data/ train data/lang_bigram"
	exit 1
fi
...
# task 31
ln -s $(pwd)/$model_dir/31.mdl $model_dir/final.mdl
